...
class Recruit(AbstractBaseUser, PermissionsMixin):
    ...
    rank = models.CharField(verbose_name=_("Rank"), max_length=255, default="", blank=True)
    name = models.CharField(default="", max_length=255)
    arm = models.CharField(verbose_name=_("Arm"), max_length=255, default="", blank=True)
    blood_type = models.CharField(verbose_name=_("Blood Type"), max_length=255, default="", blank=True)
    unit = models.CharField(verbose_name=_("Unit"), max_length=255, default="", blank=True)
    current_job = models.CharField(verbose_name=_("current_job"), max_length=255, default="", blank=True)
    college = models.CharField(verbose_name=_("college"), max_length=255, default="", blank=True)
    home_phone = models.CharField(verbose_name=_("home_phone"), max_length=255, default="", blank=True)
    email_address = models.CharField(verbose_name=_("email_address"), max_length=255, default="", blank=True)
    ...
    religion = models.CharField(verbose_name=_("Religion"), max_length=255, blank=True, default="")
    national_number = models.CharField(max_length=14, verbose_name=_("National Number"), blank=True, default="")
    date_of_graduation = models.DateField(verbose_name=_("Date of Graduation"), blank=True, null=True)

    education = models.CharField(verbose_name=_("Education"), max_length=255,default="", blank=True)
